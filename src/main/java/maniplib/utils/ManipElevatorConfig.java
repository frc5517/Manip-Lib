...
public class ManipElevatorConfig {
    ...
    public ManipElevatorConfig(DCMotor manipMotorType, ElevatorFeedforward elevatorFeedforward, double elevatorGearing, double elevatorDrumRadius, double elevatorCarriageMass, double maxHeight, double minHeight, double elevatorWidth, double elevatorHeight) {
